...
let button = document.getElementById("btn"); //akses element button

button.addEventListener("click", function bmiCalculator(){
    //mengambil input dari user
    const tinggiInput = parseInt (document.getElementById("tinggiInput").value); //ubah string jadi num
    const beratInput = parseInt (document.getElementById("beratInput").value); //ubah string jadi num
    const result = document.getElementById("resultAngka"); //untuk menampilkan hasil ke element output
